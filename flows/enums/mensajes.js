...
module.exports = {
    // Existing messages
    greetings: '✨ ¡Hola, bella! Gracias por tu interés en nuestros productos 👑💖',
    askName: '📍 ¿Cuál es tu nombre completo?',
    askAddress: '😊 Ahora dime tu dirección completa (Ciudad, Barrio).',
    ...
    menucompra:'1️⃣ Para comprar la cinturilla sola ⏳✨\n' +
        '2️⃣ para comprar la cinturilla con chaleco 👗🔥\n' +
        '✍️ Escribe el número de la opción que deseas comprar. 🚀😊',
    menuPrompt: '📢 ¡Elige tu opción y recibe más info al instante! 👇\n\n' +
    ...
    furtherAssistance: '📍 ¿Puedo ayudarte en algo mas?\n*SI* o *NO*',
    materialChaInfo: [
        '✨ Material de la Cinturilla 13 Varillas Con Chaleco ✨',
        '😍 ¡Transforma tu figura! 😍',
        '',
        '👗 Confeccionada con Powernet, un material elástico y resistente que ofrece compresión y firmeza en el abdomen. Además, cuenta con control de abdomen alto, medio y bajo para una silueta perfecta.',
        '',
        '🔥 Beneficios:',
        '✅ Control total en tres niveles de abdomen 💃',
        '✅ Ajuste cómodo y seguro 🌟',
        '✅ Alta calidad y durabilidad del material 💖',
        '',
        '💁🏻‍♀️ ¡Máxima comodidad y resultados impresionantes con el mejor chaleco de compresión! 😍'
    ],
};